 ...
 * @since 2023-05-09
 **/
@SpringBootTest(classes = PPengModuleSearchApplication.class)
@Slf4j
public class TestEs {
    ...
    public void batchInsert() {
        ...
        // 使用bulk方法批量索引文档
        elasticsearchTemplate.bulkIndex(indexQueryList, IndexCoordinates.of("goods"));
    ...
    public void update() {
         ...
         */
        elasticsearchTemplate.index(indexQuery, IndexCoordinates.of("goods"));
    ...
    public void partialUpdate() {
        ...
        UpdateQuery updateQuery = UpdateQuery.builder("10006")
                ...
                .build();
        elasticsearchTemplate.update(updateQuery, IndexCoordinates.of("goods"));
    ...
    public void filter() throws JsonProcessingException {
        ...
        NativeQuery nativeQuery = new NativeQueryBuilder()
                .withQuery(boolQuery)
                .build();
        SearchHits<Goods> searchHits = elasticsearchTemplate.search(nativeQuery, Goods.class, IndexCoordinates.of("goods"));
    ...
    public void list() {
        ...
        searchHits.stream().map(SearchHit::getContent).forEach(System.out::println);
